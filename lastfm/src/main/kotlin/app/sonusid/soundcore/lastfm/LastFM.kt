...
package app.sonusid.soundcore.lastfm

import app.sonusid.soundcore.lastfm.models.Authentication
import app.sonusid.soundcore.lastfm.models.LastFmError
import app.sonusid.soundcore.lastfm.models.TokenResponse
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        userAgent("SoundCore (https://github.com/koiverse/SoundCore)")
