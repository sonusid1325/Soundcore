...
import app.sonusid.soundcore.constants.QueueEditLockKey
import app.sonusid.soundcore.extensions.metadata
import app.sonusid.soundcore.extensions.move
import app.sonusid.soundcore.extensions.togglePlayPause
import app.sonusid.soundcore.extensions.toggleRepeatMode
...
import app.sonusid.soundcore.ui.component.MediaMetadataListItem
import app.sonusid.soundcore.ui.menu.AddToPlaylistDialog
import app.sonusid.soundcore.ui.menu.PlayerMenu
import app.sonusid.soundcore.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is app.sonusid.soundcore.together.TogetherSessionState.Joined &&
            (togetherSessionState as app.sonusid.soundcore.together.TogetherSessionState.Joined).role is app.sonusid.soundcore.together.TogetherRole.Guest
                                            ...
                                            onClick = {
                                                if (selection) {
                                                    ...
                                                    if (index == currentWindowIndex) {
                                                        ...
                                                        val joined =
                                                            togetherSessionState as? app.sonusid.soundcore.together.TogetherSessionState.Joined
                                                        val isGuest = joined?.role is app.sonusid.soundcore.together.TogetherRole.Guest
                                                        if (isGuest) {
