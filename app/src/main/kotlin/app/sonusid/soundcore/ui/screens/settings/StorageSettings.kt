...
import app.sonusid.soundcore.constants.MaxImageCacheSizeKey
...
import app.sonusid.soundcore.extensions.tryOrNull
...
import app.sonusid.soundcore.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                app.sonusid.soundcore.utils.ArtworkStorage.clear(context)
            }
        }
    }
