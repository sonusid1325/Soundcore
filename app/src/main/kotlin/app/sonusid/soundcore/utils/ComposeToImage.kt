...
import app.sonusid.soundcore.ui.component.LyricsShareImageOptions
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: app.sonusid.soundcore.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: app.sonusid.soundcore.ui.component.LyricsGlassStyle.FrostedDark
