...
import app.sonusid.soundcore.constants.*
import app.sonusid.soundcore.extensions.*
import app.sonusid.soundcore.ui.screens.settings.ThemePalettes
import app.sonusid.soundcore.ui.theme.ThemeSeedPalette
import app.sonusid.soundcore.ui.theme.ThemeSeedPaletteCodec
...
import app.sonusid.soundcore.utils.clearPlaybackWebAuthSession
import app.sonusid.soundcore.utils.clearPlaybackAuthSession
import app.sonusid.soundcore.innertube.YouTube
import app.sonusid.soundcore.innertube.models.YouTubeLocale
import app.sonusid.soundcore.kugou.KuGou
import app.sonusid.soundcore.lastfm.LastFM
import app.sonusid.soundcore.canvas.SoundCoreCanvas
import app.sonusid.soundcore.ui.player.CanvasArtworkPlaybackCache
...
import app.sonusid.soundcore.utils.toPlaybackAuthState
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(app.sonusid.soundcore.utils.GlobalLogTree())
        } catch (_: Exception) {}
    ...
    private fun initializeCriticalSync() {
        ...
        SoundCoreCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
