...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: app.sonusid.soundcore.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: app.sonusid.soundcore.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is app.sonusid.soundcore.together.JoinDecision -> {
